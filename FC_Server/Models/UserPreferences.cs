...
public class UserPreferences
{
    ...
    public static UserPreferences? UpdateUserPreferences(int preference_id, int user_id, string shelter_type, bool accessibility_needed, int num_default_people, bool pets_allowed)
    {
        DBservices dbs = new DBservices();
        return dbs.UpdateUserPreferences(preference_id, user_id, shelter_type, accessibility_needed, num_default_people, pets_allowed);
    }
