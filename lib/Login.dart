...
import 'location_background_service.dart'; // הוספת ייבוא לשליחת מיקום מיידי
import 'main.dart'; // ייבוא הפונקציה ensureLocationPermissionAndService
...
class _LoginPage extends State<LoginPage> {
  ...
  Future<void> loginUser() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // שליחת מיקום מיידית לאחר התחברות
        try {
          final now =
              DateTime.now()
                  .toUtc()
                  ...
                  .toIso8601String();
          await sendLocationNowWithCreatedAt(now);
        } catch (e) {
          // אפשר להשאיר טיפול בשגיאה, אך לא להציג SnackBar
        }
        // הפעלת טיימר לשליחת מיקום כל 3 דקות
  ...
  void initState() {
    super.initState();
    // הצגת דיאלוג הרשאת מיקום רק במסך ההתחברות
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ensureLocationPermissionAndService(context);
    });
  }
                      ...
                      children: [
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintTextDirection:
                                TextDirection.rtl, // כיוון טקסט ברמז
                            filled: true,
