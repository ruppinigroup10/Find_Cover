...
class MyApp extends StatelessWidget {
  ...
  /// חילוץ פרטי המרחב המוגן מהודעת FCM
  Map<String, dynamic> _extractShelterDetails(Map<String, dynamic> data) {
  ...
  Widget build(BuildContext context) {
    // הטיפול ב-FCM מתבצע כבר ב-initializeFCM, אין צורך בכפילות

    return MaterialApp(
      debugShowCheckedModeBanner: false,
      title: 'FC Flutter',
      navigatorKey: navigatorKey, // הוספת NavigatorKey לניווט FCM
      ...
      home: Builder(
        builder: (context) {
          ...
          // בדיקה אם האפליקציה נפתחה על ידי לחיצה על הודעה
          FirebaseMessaging.instance.getInitialMessage().then((
            ...
            if (message != null) {
              ...
              // יש לטפל בהודעה אחרי שהאפליקציה נטענת
              WidgetsBinding.instance.addPostFrameCallback((_) {
                if (message.data['code'] == 'FIND_SHELTER' ||
                  ...
                  print("🎯 Opening navigation from closed app state...");
                  // נווט למסך ניווט
                  Navigator.of(context).pushReplacement(
                    MaterialPageRoute(
                      builder:
                          (context) => NavigationMapPage(
                            shelterDetails: _extractShelterDetails(
                              message.data,
                            ),
                          ),
                    ),
