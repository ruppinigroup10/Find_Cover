    ...
    return Scaffold(
      body: Padding(
        padding: const EdgeInsets.only(
          bottom: 25.0,
        ), // מוסיף ריווח מתחת לכל תוכן העמוד
        child: child, // התוכן של העמוד
      ),
          ...
          Positioned(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  final Uri telUri = Uri(scheme: 'tel', path: '100');
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Directionality(
                          textDirection: TextDirection.rtl,
                          child: Text('לא ניתן להפעיל את החייגן'),
                        ),
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.red, // אדום
                  shape: const CircleBorder(),
