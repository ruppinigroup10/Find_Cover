...
import 'package:url_launcher/url_launcher.dart'; // ייבוא של url_launcher
          ...
          Positioned(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  // פתיחת חייגן עם המספר 100
                  const phoneNumber = '100';
                  final Uri launchUri = Uri(scheme: 'tel', path: phoneNumber);
                  try {
                    // יש לייבא את url_launcher
                    await launchUrl(launchUri);
                  } catch (e) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('לא ניתן להפעיל חייגן')),
                    );
                  }
                },
                style: ElevatedButton.styleFrom(
